...
class HousePricePredictor:
    ...
    '''
    def __init__(self,model_path = 'model_deployment/robocop_model.cbm'):
        '''
...
def predict(preprocessed_data, model_path='model_deployment/robocop_model.cbm') :
    '''
...
def predict_with_error_handling(preprocessed_data, model_path = 'model_deployment/robocop_model.cbm',):
    '''
